...
<head>
    ...
    <title>Otaku Drips - Anime clothing Store</title>
...
<body>
    ...
    <main>
        ...
        <div class="product-showcase">
            <div class="product-column">
                <video autoplay muted loop>
                    <source src="./images/IMG_2343.MP4" type="video/mp4">
                </video>
                <div class="banner-overlay">
                    <img src="./images/Otaku-Drips-7-30-2025.png" alt="Banner Logo" class="banner-logo">
                        <div class="product-info">
                            <h1 class="tagline">Grab What You Actually Deserve!</h1>
                             <a href="#logo-section" class="shop-now-btn" id="logo-section">See Further!</a>
                        </div>
                </div>
            </div>
        ...
        <!-- About Section -->
        <section class="about">
            <h2>Anime Minimalism at its Finest</h2>
            <p>Otaku Drips designs are minimal, aesthetic, and can be freely worn without the constant fear of being judged. The quality of our prints combined with breathable and superior quality clothing ensures complete satisfaction.</p>
        </section>
        ...
        <div class="service">
            ...
            <p>If you don't find it premium enough, the return is on us.</p>
        </div>

        <div class="service">
            <div class="icon">🌍</div>
            <h3>Worldwide Shipping</h3>
            <p>Get your orders delivered to you anywhere in the world.</p>
        </div>
        ...
        <div class="faq-container">
            ...
            <p>We ship worldwide except for select countries due to customs restrictions. Check our Shipping Policy for the full list.</p>
            </details>

            <details>
            <summary>How long does delivery take?</summary>
            <p>Shipping times are typically 6–8 days for USA, Canada, Europe, & Australia. All other locations take 8–12 days depending on your region.</p>
            </details>
            ...
            <p>We offer all sizes from S to XXL. Please refer to the size chart on each product page before ordering.</p>
            </details>

            <details>
            <summary>Can I cancel or modify my order?</summary>
            <p>Orders can be canceled or modified within 2 hours of placement. After that, we cannot guarantee changes due to processing.</p>
            </details>

            <details>
            <summary>What’s your return policy?</summary>
            <p>We accept returns within 7 days of delivery. Items must be unworn and in original packaging. Check our <a href="return.html">Return Policy</a>.</p>
            </details>

            <details>
            <summary>Do you restock limited edition items?</summary>
            <p>Some designs may be restocked based on demand, but limited edition items often sell out permanently. Follow us on social media for updates!</p>
            </details>
        </div>
        </section>
